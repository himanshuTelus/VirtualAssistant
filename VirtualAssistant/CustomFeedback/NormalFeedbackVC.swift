...
class NormalFeedbackVC: UIViewController {
       ...
       // @IBOutlet weak var feedTextViewContainerHC: NSLayoutConstraint!
        ...
        var NavTitleImg:UIImage = UIImage(named: "user1", in: Bundle(for: NormalFeedbackVC.self), with: nil)!
    ...
    func addNavTitleImage()  {
        ...
        @IBAction func emojiBtnAction(_ sender: UIButton) {
            ...
            case 0:
                print("")
                emj1Button.setBackgroundImage(UIImage(named: "4-f", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
                emj2Button.setBackgroundImage(UIImage(named: "6", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
                emj3Button.setBackgroundImage(UIImage(named: "7", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)

            case 1:
                print("")
                emj1Button.setBackgroundImage(UIImage(named: "4", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
                emj2Button.setBackgroundImage(UIImage(named: "6-f", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
                emj3Button.setBackgroundImage(UIImage(named: "7", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
            case 2:
                print("")
                emj1Button.setBackgroundImage(UIImage(named: "4", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
                emj2Button.setBackgroundImage(UIImage(named: "6", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
                emj3Button.setBackgroundImage(UIImage(named: "7-f", in: Bundle(for: NormalFeedbackVC.self), with: nil), for: .normal)
            default:
                print("")
            }
